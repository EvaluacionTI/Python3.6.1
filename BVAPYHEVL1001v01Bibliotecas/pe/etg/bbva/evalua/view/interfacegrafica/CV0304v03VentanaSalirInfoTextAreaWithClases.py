...
#
# Ventana para mostrar la información de la ventana y de los widgets que mostrará en la ventana
# de manera adecuada
#==============================================================================
from tkinter import *
from tkinter import ttk

# La clase 'Aplicacion' ha crecido. En el ejemplo se incluyen nuevos widgets en el método
# constructor __init__(): Uno de ellos es el botón 'Info'  que cuando sea presionado llamará
# al método 'verinfo' para mostrar información en el otro widget, una caja de texto:
# un evento ejecuta una acción:


class Aplicacion():
    def __init__(self):
        # En el ejemplo se utiliza el prefijo 'self' para declarar algunas variables asociadas al objeto
        # ('mi_app')  de la clase 'Aplicacion'. Su uso es imprescindible para que se pueda acceder a sus
        # valores desde otros métodos:

        self.raiz = Tk()
        self.raiz.geometry('300x200')

        # Impide que los bordes puedan desplazarse para ampliar o reducir el tamaño de la ventana 'self.raiz':
        ...
        # Sitúa la caja de texto 'self.tinfo' en la parte superior de la ventana 'self.raiz':

        self.tinfo.pack(side=TOP)

        # Define el widget Button 'self.binfo' que llamará al metodo 'self.verinfo' cuando sea presionado
        ...
        # Define el botón 'self.bsalir'. En este caso cuando sea presionado, el método destruirá o
        # terminará la aplicación-ventana 'self.raíz' con 'self.raiz.destroy'

        self.bsalir = ttk.Button(self.raiz, text='Salir', command=self.raiz.destroy)

        # Coloca el botón 'self.bsalir' a la derecha del objeto anterior.

        self.bsalir.pack(side=RIGHT)

        # El foco de la aplicación se sitúa en el botón 'self.binfo' resaltando su borde. Si se presiona
        # la barra espaciadora el botón que tiene el foco será pulsado. El foco puede cambiar de un widget
