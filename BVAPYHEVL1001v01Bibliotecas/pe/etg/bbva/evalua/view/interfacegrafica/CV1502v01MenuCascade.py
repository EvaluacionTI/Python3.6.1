...
oLabelMenuItemProcesos = oFormatMenu(oLabelMenu)
oLabelMenuItemProcesos.add_command(label="Cargar Información de Predios")
oLabelMenuItemProcesos.add_command(label="Generar archivos PDF de HR")
oLabelMenuItemProcesos.add_command(label="Generar archivos PDF de HP")
